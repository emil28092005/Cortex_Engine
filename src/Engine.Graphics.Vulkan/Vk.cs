...
internal static unsafe class Vk
{
    ...
    public delegate VkResult VkCreateSampler(VkDevice device, VkSamplerCreateInfo* pCreateInfo, nint pAllocator, VkSampler* pSampler);
    public delegate void VkDestroySampler(VkDevice device, VkSampler sampler, nint pAllocator);
    ...
    public static VkCreateSampler vkCreateSampler;
    public static VkDestroySampler vkDestroySampler;
    ...
    public static void LoadDeviceFunctions(VkDevice device)
    {
        ...
        vkCreateSampler = LoadDev<VkCreateSampler>(p, "vkCreateSampler");
        vkDestroySampler = LoadDev<VkDestroySampler>(p, "vkDestroySampler");
